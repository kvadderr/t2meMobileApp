        ...
        try {
            ...
            agoraEngine.registerEventHandler({
                onJoinChannelSuccess: () => {
                    showMessage('OPERATOR channel with role ' + user.role);
                    setIsJoined(true);
                },
    ...
    return (
        <View style={styles.container}>
            <View style={styles.available}>
                <Text style={styles.availableText}>{balance} Avialable</Text>
            </View>
            <View style={styles.callDetail}>
                <Image 
                    ...
                    style={styles.avatar}
                />
                <Text style={styles.opponentName}>{callData.FIO}</Text>
